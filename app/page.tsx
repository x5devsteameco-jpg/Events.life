    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/register" className="hidden md:block text-sm font-bold px-5 py-2.5 rounded-xl" style={{ color: '#020408', background: 'linear-gradient(135deg, #00c4a8, #00e5cc)', boxShadow: '0 0 20px rgba(0,229,204,0.25)' }}>Get Started</Link>
          ...
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.2 }} className="md:hidden overflow-hidden" style={{ borderTop: '1px solid rgba(0,229,204,0.08)' }}>
            <div className="px-6 py-4 space-y-1">
              ...
              <div className="pt-3 flex flex-col gap-2">
                ...
                <Link href="/register" onClick={() => setMobileOpen(false)} className="block py-2.5 text-center text-sm font-bold rounded-xl" style={{ color: '#020408', background: 'linear-gradient(135deg, #00c4a8, #00e5cc)' }}>Get Started</Link>
              </div>
            </div>
          </motion.div>
        )}
...
export default function HomePage() {
  const features = [
    { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>, title: 'Full Event Control', body: 'Draft, publish, pause or end events at any time. Set visibility, capacity, and attendee requirements exactly how you need.', accent: '#00e5cc' },
    { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>, title: 'Age Gates Built-In', body: 'Set minimum age requirements (18, 19, 21+). Attendees verify before seeing event details. Fully compliance-ready.', accent: '#ff3cac' },
    { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="23 21 23 19 19 19"/><line x1="19" y1="13" x2="23" y2="13"/></svg>, title: 'RSVP & Lead Capture', body: 'Collect store name, brand, position, and certifications from every attendee. Export to CSV at any time.', accent: '#00e5cc' },
    { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>, title: 'Custom Questions', body: 'Add your own RSVP fields — text, dropdowns, or checkboxes. Perfect for dietary needs, product preferences, or compliance checks.', accent: '#00e5cc' },
    { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, title: 'Email Blast Invites', body: 'Paste a list of emails and send personalized invites instantly. Track RSVPs directly from your dashboard.', accent: '#00e5cc' },
    { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>, title: 'Team Sharing', body: 'Invite team members to co-manage events with view or edit permissions. No extra seats to purchase.', accent: '#00e5cc' },
  ];
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          >
            <motion.div whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }} transition={{ type: 'spring', stiffness: 400, damping: 17 }}>
              <Link href="/register" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 font-bold" style={{ color: '#020408', background: 'linear-gradient(135deg, #00d1b3, #00f0d3)', padding: '14px 32px', borderRadius: '14px', fontSize: '1rem', boxShadow: '0 0 32px rgba(0,229,204,0.3), 0 8px 24px rgba(0,0,0,0.4)', minHeight: '52px' }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <AnimSection delay={0.12}>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {[
                { label: 'Networking', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>, slug: 'NETWORKING' },
                { label: 'Product Demo', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>, slug: 'PRODUCT_DEMO' },
                { label: 'Private Gathering', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>, slug: 'PRIVATE_GATHERING' },
                { label: 'Industry Event', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>, slug: 'INDUSTRY_EVENT' },
                { label: 'Trade Show', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>, slug: 'TRADE_SHOW' },
                { label: 'Tech & Innovation', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>, slug: 'TECH' },
                { label: 'Arts & Culture', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72m2.54-15.38c-3.72 4.35-8.94 5.66-16.88 5.85m19.5 1.9c-3.5-.93-6.63-.82-8.94 0-2.58.92-5.01 2.86-7.44 6.32"/></svg>, slug: 'ARTS' },
                { label: 'VIP Experience', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>, slug: 'VIP' },
              ].map((cat) => (
                <Link
                  key={cat.slug}
