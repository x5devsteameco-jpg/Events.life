...
Call log:
  ...
  - waiting for locator('input[name="search"]')
    2 × locator resolved to <input name="search" placeholder="Search events…" class="w-full h-12 pl-10 pr-4 rounded-xl text-sm text-[#e8f4f8] outline-none focus:ring-2 focus:ring-[rgba(0,229,204,0.3)] transition-all"/>
