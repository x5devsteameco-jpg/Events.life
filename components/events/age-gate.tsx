  ...
  if (denied) {
    return (
      <div className="rounded-2xl p-8 text-center" style={{ background: 'rgba(12,26,31,0.85)', border: '1px solid rgba(255,60,172,0.2)' }}>
        ...
        <h3 className="text-lg font-black text-[#ff3cac] mb-2" style={{ fontFamily: 'var(--font-display)' }}>Access Restricted</h3>
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <h3 className="text-xl font-black text-[#e8f4f8] mb-2" style={{ fontFamily: 'var(--font-display)' }}>Age Verification</h3>
